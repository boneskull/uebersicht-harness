 ...
 *
 * Automatically discovers and loads all widgets from the Übersicht widgets
 * directory.
 *
 * The widgets path is configurable via vite.config.js (see @widgets alias). By
 * default, it uses ~/Library/Application Support/Übersicht/widgets on macOS.
 *
 * You can override this by setting the UEBERSICHT_WIDGETS_DIR environment
