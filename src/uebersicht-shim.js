 ...
 *
 * Provides the same exports as the real 'uebersicht' module so widgets can be
 * rendered in a browser debugging environment.
 *
...
/**
 * Mock shell command runner In the real Übersicht, this executes shell commands
 * and returns the output. Here we just log and return empty - the harness
 * provides simulated output.
 *
 * @param {string} command - Shell command to "run"
 * @returns {Promise<string>} - Resolves with empty string (or rejected with
 *   error)
 */
...
/**
 * Mock HTTP request function In the real Übersicht, this is superagent. Here we
 * provide a minimal mock that logs requests.
 */
